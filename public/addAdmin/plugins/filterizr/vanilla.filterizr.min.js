var Filterizr = function (t) {
    ...
    "use strict";
    var r = {IDLE: "IDLE", FILTERING: "FILTERING", SORTING: "SORTING", SHUFFLING: "SHUFFLING"}, i = {
            SAME_SIZE: "sameSize",
    ...
    var d = function (t) {
        ...
        filterInCss: {opacity: 0, transform: "scale(1)"},
    ...
    var S, O = function (t, e, n, r) {
        ...
        return T(e, t), e.prototype.initialize = function () {
            ...
            var t = this.options.get().gutterPixels, e = this.node.parentElement.clientWidth, n = this.node.clientWidth,
        ...
        return V(e, t), Object.defineProperty(e.prototype, "styles", {
            ...
            var t = this, e = this.options.get(), n = e.animationDuration, i = e.callbacks, o = e.delay,
                s = e.delayMode, u = e.gridItemsSelector, c = "progressive" === s ? o * this.filterItems.length : o;
    ...
    var ut = function () {
        ...
        return t.prototype.init = function (t) {
            ...
            return t.used = !0, t.down = {x: t.x, y: t.y + n, w: t.w, h: t.h - n}, t.right = {
                x: t.x + e,
                y: t.y,
                w: t.w - e,
                h: n
        ...
        switch (o) {
                ...
                return function (t, e) {
                    return {
                        containerHeight: Math.max.apply(Math, t.map(function (t) {
                            return t.height
                        })) + 2 * e, itemsPositions: t.map(function (n, r) {
            ...
            case i.VERTICAL:
                return function (t, e) {
                    return {
                        containerHeight: at(t, e) + e, itemsPositions: t.map(function (n, r) {
            ...
            case i.SAME_WIDTH:
                return function (t, e, n) {
                    var r = Math.floor(t / (e[0].width + n)), i = e.map(function (t, i) {
                        ...
                        return {
                            left: (i - r * s) * (o + n), top: e.slice(0, i).filter(function (t, e) {
                                return (i - e) % r == 0
                            }).reduce(function (t, e) {
                                return t + e.height + n
                            }, 0)
    ...
    var ht = function (t, e, n, r) {
        ...
        return Object.defineProperty(t.prototype, "filterItems", {
            ...
            var e = this.filterContainer, n = this.filterItems,
        ...
        }, t.FilterContainer = J, t.FilterItem = N, t.defaultOptions = v, t.installAsJQueryPlugin = ft, t
    }();
    n.d(e, "a", function () {
        return yt
    })
